...
import { ISheetparserProps } from './components/ISheetparserProps';

export interface ISheetparserWebPartProps {
  description: string;
}

export default class SheetparserWebPart extends BaseClientSideWebPart<ISheetparserWebPartProps> {
